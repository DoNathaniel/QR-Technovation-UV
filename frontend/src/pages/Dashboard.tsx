      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        >
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl" style={{ backgroundColor: '#3d1ccf' + '20' }}>
              <svg className="w-7 h-7" style={{ color: '#3d1ccf' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 3v4m8-4v4M5 11h14M5 5h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2zm4 10l2 2 4-4" />
              </svg>
            </div>
            <div>
              <h3 className="font-semibold text-lg text-gray-800 group-hover:text-blue-600 transition-colors">Mi asistencia</h3>
              <p className="text-sm text-gray-500">Consulta tu historial y justifica tus inasistencias.</p>
            </div>
          </div>
        </Link>
        ...
        {canAccess(['superadmin', 'admin']) && (
          <>
            ...
            <Link
              to="/asistencia-mentores"
              className="group bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-lg hover:border-purple-200 transition-all"
            >
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-xl" style={{ backgroundColor: colors.secondary + '20' }}>
                  <svg className="w-7 h-7" style={{ color: colors.secondary }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a3 3 0 006 0M9 5a3 3 0 016 0m-6 9l2 2 4-4" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-semibold text-lg text-gray-800 group-hover:text-purple-600 transition-colors">Asistencia de Mentores</h3>
                  <p className="text-sm text-gray-500">Registra y consulta la asistencia del equipo.</p>
                </div>
              </div>
            </Link>
